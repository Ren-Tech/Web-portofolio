...
import { SiMysql, SiCplusplus, SiFirebase } from "react-icons/si";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-yellow-500 rounded-full filter blur-3xl"></div>
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-red-500 rounded-full filter blur-3xl"></div>
      </div>
